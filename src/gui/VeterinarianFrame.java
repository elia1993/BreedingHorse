...
public class VeterinarianFrame extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VeterinarianFrame window = new VeterinarianFrame(bh);
	...
	public VeterinarianFrame(BreedingHorses bh) {
		super("Veterianrians");
		...
		btnNewButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent event) {
		        	 AddVeterinarian at = new AddVeterinarian(bh,ListPeopleModel);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
	         public void actionPerformed(ActionEvent event) {
	        	 ...
	        	 String worker_id = selectedVal[3];
	        	 Veterinarian trainer_remove = new Veterinarian(id, worker_id);
