...
public class BookMakerFrame extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookMakerFrame window = new BookMakerFrame(bh);
	 ...
	 */
	public BookMakerFrame(BreedingHorses bh) {
		super("BookMaker");
		...
		btnNewButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent event) {
		        	 AddBookMaker at = new AddBookMaker(bh,ListPeopleModel);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
	         public void actionPerformed(ActionEvent event) {
	        	 ...
	        	 BookMaker trainer_remove = new BookMaker(id, worker_id);
