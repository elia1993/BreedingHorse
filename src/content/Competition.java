...
public class Competition {
	...
	/** 
	 * The primary key of Competition is serialNum and type 
	 **/
	...
	**/
	 ...
	 * @param level
	 */
	public Competition(int serialNum, String placeOfCompetitions, Type type,
	 ...
	 * @param type
	 */
	public Competition(int serialNum, Type type) {
		this.setSerialNum(serialNum);
		this.setType(type);
	}
	...
	/**
	 * Checks if the primary key (serialNum and type) is equal to to that of the
	 * given obj
	 */
	 ...
	 * 
	 * Participating in a competition of type SHOW_JUMPING:
	 * Only for horses above the age of one year with and Equestrian with a JUNIOR rank 
	 * 
	 * Participating in a competition of type CROSS_COUNTRY: opened for all horses
	 * 
	 * Participating in a competition of type BARELL:
	 * Only for a horse with age of less than one year and Equestrian with a MASTER or EXPERT rank 
	 * 
	 * Participating in a competition of type TROT:
	 * Only for a horse that his trainer has a success rate above 300 points
	 * 
	 * Participating in a competition of type GALLOP:
	...
	public boolean checkHorseFitness(Horse horse) {
		...
		} else if (this.getType().equals(Type.CROSS_COUNTRY)) {
			return true;
		}
		return false;
	...
	public String toString() {
		return "\nThe Competition serialNum is: " + this.getSerialNum()
				+ "\nThe Competition type is: " + this.getType().toString()
